...
(function() {
  ...
  Worker = (function() {
      ...
      this.pubsub.on('message', (function(_this) {
        return function(channel, message) {
          if (channel === 'FAIRY:COMPLETE') {
            return _this.removeLock(message);
          }
    ...
    Worker.prototype.removeLock = function (message) {
      var task = JSON.parse(message);
      delete this.queue.workingTasks[task[0]];
      return;
    };
    ...
    Worker.prototype.start = function() {
      ...
      return this.redis.lindex(this.key('SOURCE'), 0, (function(_this) {
        return function(err, res) {
          ...
          if (task && !_this.queue.workingTasks[task[0]]) {
            _this.queue.workingTasks[task[0]] = true;
